...
int ARA_pthread_attr_setschedparam_syscall_(pthread_attr_t *__restrict, const int);

// param is explicitly non-NULL so we do not need to check.
#define pthread_attr_setschedparam(attr, param) ARA_pthread_attr_setschedparam_syscall_((attr), ((const struct sched_param*)(param))->sched_priority)
